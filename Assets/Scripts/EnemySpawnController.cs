...
public class EnemySpawnController : MonoBehaviour
{
    ...
    private Vector3 getSpawnLocation()
    {
        ...
        Debug.Log("Trying to find spawn location when player is at " + player.transform.position);
        for (int attempt = 0; attempt < 10; ++attempt)
        {
            ...
            Debug.Log("Rejected direction " + spawn_direction + " resulting in position " + spawn_pos);
        }
